        ...
        $('.rc_inventory_give').click(function () {
            for (var id in RustCalculator.selected) {
                $.ajax({
                    ...
                    type: "POST",
                    data: {
                        name: RustCalculator.entity[id].name,
                        count: RustCalculator.selected[id].count,
                        nick: $("#rc_inventory_button select").val(),
                        return: 0
                    },
                    async: false,
                    success: function (data) {
...
RustCalculator.init('js/RustCalculatorExp.json');
